...
class SignUpController extends GetxController {
  ...
  final editConfirmPassword = TextEditingController(); // Tambahkan ini
  ...
  execute(BuildContext context) {
    ...
    if (editConfirmPassword.text == '') { // Tambahkan ini
      AppInfo.failed(context, 'Konfirmasi kata sandi wajib diisi');
      return;
    }

    if (editPassword.text != editConfirmPassword.text) { // Tambahkan ini
