import 'package:coworker_mobile/widget/input_title.dart';

import 'package:flutter/material.dart';

class InputAuthPassword extends StatefulWidget {
  const InputAuthPassword(
      {super.key, required this.hint, required this.editingController, required this.title});
  final String hint;
          ...
          child: Row(
            children: [
              ...
              IconButton(
                ...
                icon: ImageIcon(
                  AssetImage(
                    hide ? 'assets/ic_eye_closed.png' : 'assets/icon_eye_open.png',
                  ),
                ),
              )
            ],
